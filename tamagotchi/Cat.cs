...
namespace tamagotchi
{
    ...
    class Cat
    {
        ...
        public Cat(string name = "Дружочек", string color = "Пурпурный")
        {
            this.name = name;
            this.color = color;
            health = 100;
        ...
        {
            Console.WriteLine($"Кошка сьела {f.type}.{f.heath} здоровья");
        }
        ...
        {
            Console.WriteLine("Список ударов: 1. Удар лапкой, 2. злой кусь, 3. закруглени" +
                "е битвы");
